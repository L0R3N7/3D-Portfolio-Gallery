...
Im Projekt wurde das Plugin Iconify verwendet. Dadurch wird das UI-Prototyping Werkzeug Figma durch eine weitere Oberfläche erweitert. Auf dieser Oberfläche kann nach Icons gesucht und diese Icons direkt im Design verwendet werden. Dadurch beschleunigte sich der Designprozess.
