...
\subsection{UserInterface-Frameworks (UI-Frameworks) [L]}
...
Angular Material bietet eine hohe Anzahl an sofort einsetzbaren Komponente. Zu allen diesen Komponenten gibt es eine ausführliche Dokumentation mit Beispiele. \cite{JavaPointAngularMaterial, WhatAngularMaterial}
...
\subsubsection{Alternativen 3D Web Apis [L]}
