\section{Fertige Landingpage [Team]}
...
\begin{compactitem}
    ...
    \begin{compactitem}
        ...
        \item einen Call-To-Action (CTA) Button, welcher den*die User*in dazu einlädt, seine*ihre eigene Ausstellung zu erstellen. Beim Betätigen wird der Benutzer bei bestehender Anmeldung zum Editor weitergeleitet, und ansonsten auf die Login-Seite verwiesen.
    \end{compactitem}
\end{compactitem}
