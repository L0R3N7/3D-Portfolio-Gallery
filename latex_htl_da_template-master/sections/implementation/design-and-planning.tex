...
\begin{compactitem}
    ...
    \item Interaktion
    \item Kommunikation
    \item maschieneles Lehren
\end{compactitem}

\cite{MaterialDesign-Introduction}

\paragraph{Bootstrap}
Bootstrap ist ein gratis und open-source UI-Framework. Es ist nicht nur eine Ansammlung von CSS sondern auch von JavaScript und HTML code um schöne, interaktive und responsive Webseiten. 
