...
Um auf Eingaben und Interaktionen von Benutzer*innen zu reagieren, verwendet man Event-Bindings. Dabei werden die Daten vom HTML-Template zur TypeScript-Klasse übertragen und können dort genutzt werden. Sie sind also das Gegenstück zu den Property-Bindings. \cite{AngularEventBinding}
...
\section{Routing [M]}\label{sec:Routing}
