...
Das evolutionäre Prototyping ist eine Art des Prototyping, dabei wird der Prototyp über die Dauer des gesamten Projektes weiterentwickelt, bis daraus das fertige Softwareprojekt wird. \cite{Prototyping}

In der Softwareentwicklung gibt es große Probleme, wenn Fehler und Missverständnisse aus der Spezifikationsphase eines Projektes erst zu einem späten Projektstand entdeckt werden. Denn zu diesem Zeitpunkt lassen sich nur schwer grundlegende Änderungen am Projekt machen. \cite{Prototyping}

Deswegen sollte versucht werden, sobald wie möglich auf diese Probleme zu stoßen. Dabei helfen Prototypen. Prototypen sind Annäherungen oder funktionelle Modelle von Systemteilen des fertigen Produkts. Sie werden im Vergleich zu dem Produkt mit weniger Aufwand produziert und das Klientel kann sich vorab ein Bild machen und Missverständnisse kommen durch die vermehrte Absprache mit der Kundschaft weniger auf. \cite{Prototyping}